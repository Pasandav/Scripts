...
//	private Vector3 InitialPlatformPosition;
	...
	void OnTriggerStay2D(Collider2D other)
	{
		...
		if (other.gameObject.name == "SpritePlayer")
		{
			other.transform.parent = transform;
			//CtrlPlayer.tocaSuelo = true;
			//animPlayer.SetBool ("Suelo" , true);
		}
	...
	void OnTriggerExit2D(Collider2D other)
	{
		...
		if (other.gameObject.name == "Player")
		{
			...
			//CtrlPlayer.setIsGround (false);
			//CtrlPlayer.isGround = false;
			
            animPlayer.SetBool ("Suelo", false);
		}
	}
